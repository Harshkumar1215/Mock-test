...
const App = {
            ...
            return `
                <div class="card-item" style="flex-direction:column; align-items:stretch;" onclick="App.openInstructions('${st.id}')">
                    ...
                    <div style="display:flex; align-items:center; justify-content:space-between; padding-top:8px; border-top:1px dashed var(--border);">
                        <div class="card-meta">
                            ${hasAttempts 
                                ? `<span><i class="fa-solid fa-trophy" style="color:var(--success);"></i> Best: ${stStat.highScore}/60 (${stStat.attempts} attempts)</span>`
                                : `<span><i class="fa-regular fa-clock"></i> 60 MCQs · 35 Mins</span>`
                            }
                        </div>
    ...
    launchTestEngine(subtopicId) {
        const session = TestEngine.createTestSession(subtopicId, 35);
